...
export const queryHistoryGlobalStorageFileName = "queryHistoryTree.enc";
...
export const cmdConnectWithUriOwnership = "mssql.connectWithUriOwnership";
...
export const cmdClearFinishedBackgroundTasks = "mssql.clearFinishedBackgroundTasks";
export const cmdDeleteQueryHistory = "mssql.deleteQueryHistory";
export const cmdOpenQueryHistory = "mssql.openQueryHistory";
export const cmdOpenBackgroundTask = "mssql.openBackgroundTask";
export const cmdViewBackgroundTaskLogs = "mssql.viewBackgroundTaskLogs";
...
export const cmdCancelBackgroundTask = "mssql.cancelBackgroundTask";
export const cmdBackgroundTaskAction = "mssql.backgroundTaskAction";
...
export const systemDatabases = ["master", "tempdb", "model", "msdb"];
...
export const configCopilotSdkProvidersAnthropicBaseUrl =
    "mssql.copilot.sdkProviders.anthropic.baseUrl";
export const configCopilotSdkProvidersAnthropicTimeout =
    "mssql.copilot.sdkProviders.anthropic.timeout";
export const configCopilotSdkProvidersAnthropicEnv = "mssql.copilot.sdkProviders.anthropic.env";
export const configCopilotSdkProvidersOpenAiEnabled = "mssql.copilot.sdkProviders.openai.enabled";
export const configCopilotSdkProvidersOpenAiAdditionalModels =
